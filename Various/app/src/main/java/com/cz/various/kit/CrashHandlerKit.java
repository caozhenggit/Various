 ...
 * @date 2017/11/4
 *
 * describe: 线程未捕获异常处理器，用来处理未捕获异常
 */

public class CrashHandlerKit implements UncaughtExceptionHandler {
    ...
    private static CrashHandlerKit sInstance = new CrashHandlerKit();
    private UncaughtExceptionHandler mDefaultCrashHandler;
    private Context mContext;

    private CrashHandlerKit() {
    }

    public static CrashHandlerKit getInstance() {
        return sInstance;
    }
