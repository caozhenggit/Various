...
public class FLog {
    ...
    public static void json(int logLevel, String tag, String json) {
        if (LOG) {
            ...
            FPrinter.println(logLevel, TextUtils.isEmpty(tag) ? TAG_ROOT : tag, formatJson);
        }
    }
    ...
    public static void xml(int logLevel, String tag, String xml) {
        if (LOG) {
            ...
            FPrinter.println(logLevel, TextUtils.isEmpty(tag) ? TAG_ROOT : tag, formatXml);
        }
    }
    ...
    public static void error(String tag, Throwable throwable) {
        if (LOG) {
            ...
            FPrinter.println(Log.ERROR, TextUtils.isEmpty(tag) ? TAG_ROOT : tag, formatError);
        }
    }
    ...
    private static void msg(int logLevel, String tag, String format, Object... args) {
        if (LOG) {
            ...
            FPrinter.println(logLevel, TextUtils.isEmpty(tag) ? TAG_ROOT : tag, formatMsg);
        }
    }
